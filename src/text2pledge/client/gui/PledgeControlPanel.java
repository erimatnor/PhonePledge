 ...
 */
package text2pledge.client.gui;
...
import text2pledge.client.PledgeClient;
import text2pledge.client.StatusCommandListener;
import text2pledge.command.DisplayCommand;
import text2pledge.command.RevokePledgeCommand;
import text2pledge.command.StatusCommand;
import text2pledge.googlevoice.GoogleVoiceConnector;
...
public class PledgeControlPanel extends JPanel implements 
    ...
    public static void createAndShowGUI(PledgeControlPanel ps) {
        ...
        JFrame frame = new JFrame("Text2Pledge Controller");
