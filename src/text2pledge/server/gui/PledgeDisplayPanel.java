...
import text2pledge.server.DisplayCommandListener;
...
public class PledgeDisplayPanel extends JPanel 
	...
	Pledge welcomePledge = new Pledge("Welcome to Text2Pledge!");
	...
	static final Color text2pledgeBlue = new Color(12, 85, 139);
	static final Color text2pledgeBlue2 = new Color(0, 0, 100);
	...
	public PledgeDisplayPanel() {
		try {
			logo = ImageIO.read(getClass().getResource("t2p-logo-large.png"));
		} catch (IOException e) {
	...
	public void showWelcomePledge() {
		Pledge p = new Pledge("Welcome to Text2Pledge!");
